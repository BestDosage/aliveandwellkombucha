...
export default function MarqueeSection() {
  return (
    <section
      className="relative py-16 md:py-24 overflow-hidden group"
      aria-label="Scrolling brand highlights"
      style={{ backgroundColor: "#8BA888" }}
    >
      {/* Row 1 — filled cream text, left to right */}
      <div className="flex overflow-hidden whitespace-nowrap">
        <div className="flex items-center gap-6 md:gap-10 font-heading text-5xl md:text-7xl lg:text-9xl font-bold animate-marquee group-hover:[animation-play-state:paused]" style={{ color: "#FBF7F0" }}>
      ...
      <div className="flex overflow-hidden whitespace-nowrap mt-4 md:mt-8">
        <div
          className="flex items-center gap-6 md:gap-10 font-heading text-5xl md:text-7xl lg:text-9xl font-bold animate-marquee-slow group-hover:[animation-play-state:paused]"
          style={{
